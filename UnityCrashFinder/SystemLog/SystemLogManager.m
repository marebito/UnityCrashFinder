...
+ (NSMutableArray<SystemLogMessage *> *)allLogMessagesForCurrentProcess
{
    ...
    // Filter for messages from the current process. Note that this appears to happen by default on device, but is
...
+ (NSArray<SystemLogMessage *> *)allLogAfterTime:(double)time
{
    ...
    NSArray *filteredLogMessages = [allMsg
        filteredArrayUsingPredicate:[NSPredicate
                                        predicateWithBlock:^BOOL(SystemLogMessage *logMessage, NSDictionary *bindings) {
